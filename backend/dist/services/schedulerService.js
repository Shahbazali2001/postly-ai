        ...
        try {
            ...
            for (const post of postsToPublish) {
                try {
                    ...
                    console.log(`Publishing post ${post._id} to platforms:`, zernioPlatforms);
                    ...
                    console.log(`Post ${publishedPost._id || publishedPost.id || post._id} was published successfully`);
                    ...
                    console.error(`Error publishing post ${post._id}: ${error?.message || error}`);
                    post.status = "failed";
                    await post.save();
                }
            }
